...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var app, ltaDatamallBaseURL, SSLKey, SSLCert, port;
        var _this = this;
        return __generator(this, function (_a) {
            app = express_1["default"]();
            ltaDatamallBaseURL = new URL('http://datamall2.mytransport.sg/');
            SSLKey = process.env.SSL_KEY;
            SSLCert = process.env.SSL_CERT;
            port = process.env.PORT;
            app.use(helmet_1["default"]());
            app.get('*', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var dmResponse, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, axios_1["default"].get(new URL(req.path, ltaDatamallBaseURL).href, {
                                    headers: req.headers
                                })];
                        case 1:
                            dmResponse = _a.sent();
